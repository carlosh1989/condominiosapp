...
<html>
    <head>
        ...
        background-image: url('http://res.cloudinary.com/tuconsultaenlinea/image/upload/q_auto:good/v1517417500/Mexico_Ext_01_kcxky2.jpg');
        ...
        <div class="navbarFixed">
            <nav>
                ...
                <img class="responsive-img animated rotateInDownLeft" width="115" src="https://images.vexels.com/media/users/3/137236/isolated/preview/1af2af36ebb8b6fde38f3ec8acab82bb-edificio-plano-ciudad-gran-casa-by-vexels.png">
                    <a style="color: #222;" href="<?php echo baseUrl ?>" class="brand-logo animated fadeInUp">TUCONDOMINIO.COM</a>
